...
# ==========================================
    ...
    parser.add_argument("--num_hiddens", type=int, default=1)
    ...
    while True:
      ...
      # ============================== model selection end =============================================================
        ...
        if current_model == 0:
            ...
            image_np =  ycbcr2rgb(dcarcnn_models[current_model-2].inference(rgb2ycbcr(image_np)))
            image_np = imresize(image_np, scalar_scale=args.scale, output_shape=None)
            #image_np = ycbcr2rgb(dcsrcnn.inference(rgb2ycbcr(image_np),scale=1,depth=current_model-2))
